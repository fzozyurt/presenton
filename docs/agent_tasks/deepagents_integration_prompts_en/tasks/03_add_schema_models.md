# TASK 03 — Add schema models

## Goal

Make the Deep Agents workflow schema-driven so that a modest model can follow the process reliably.
...
class EvidenceItem(BaseModel):
    id: str
    source_type: Literal["user_prompt", "uploaded_file", "web", "memory", "presentation_engine"]
...
- `DeckPlan` can be serialized to JSON and parsed back.
- Invalid quality issue severity raises validation error.
- Invalid quality issue category raises validation error.
- No database imports exist in this file.
